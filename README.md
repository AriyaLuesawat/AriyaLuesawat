...
| Area | Technologies |
| --- | --- |
| Programming | Python, JavaScript, TypeScript, SQL, C/C++, HTML, CSS |
| AI and data | TensorFlow/Keras, scikit-learn, Pandas, NLP, OCR, Computer Vision, MediaPipe |
| Backend and web | FastAPI, Next.js, React, REST APIs |
| Cloud and systems | Tencent Cloud, AWS, Google Cloud AI infrastructure, Linux |
| Networks and tools | Computer Networking, MikroTik RouterOS, Git, GitHub |
...
- Designing reproducible AI evaluation pipelines
- Deploying AI workloads with cloud GPUs and TPUs
- Building secure, observable services around machine-learning models

## Contact

- [LinkedIn](https://linkedin.com/in/ariya-luesawat-bb6280419)
- [GitHub](https://github.com/AriyaLuesawat)
- Email: [ariya06120@gmail.com](mailto:ariya06120@gmail.com)
